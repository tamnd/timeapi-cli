...
Most of these come down to network reality or how timeapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

timeapi rate-limits like any public site. timeapi already paces
...
Where a surface is gated, timeapi reads a cookie or token you supply
...
`timeapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what timeapi actually did
